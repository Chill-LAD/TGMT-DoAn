...
class HybridWatermarkModelV1(nn.Module):
    ...
    def forward(self, rgb_input, freq_input=None):
        """Forward pass: RGB features + Frequency features -> Fusion -> Classification."""
...
def create_model_v1(num_classes=2, backbone="resnet18", pretrained=True, dropout=0.5):
    """
    Factory function để tạo HybridWatermarkModelV1 (Ours v1).
    Args:
    ...
    Returns:
        HybridWatermarkModelV1 instance
    """
    model = HybridWatermarkModelV1(
...
class WatermarkDetectorV1:
    """
    Wrapper class để dễ dàng load model v1 và thực hiện inference.
